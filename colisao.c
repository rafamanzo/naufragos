...
double diferecaAngulos(estatico imovel, vetor movel_pos, vetor movel_vel, int dir)
{
	if( dir == NO || dir == SO )
...
void colidePessoaComBorda(fila naufragos, pessoa *p, int borda, int l_max, int c_max)
{
